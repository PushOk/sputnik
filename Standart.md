...
- [HTML](#html)
  ...
  - [Ссылки с протоколами](#html-links-protocol)
  - [Сокращение разметки](#html-reducing-markup)
  - [Разметка, генерируемая с помощью JavaScript](#html-javascript)

- [CSS](#css)
  - [CSS синтаксис](#css)
  - [Порядок объявления](#css)
  - [Не используйте @import](#css)
  - [Место для media query](#css)
  - [Свойства с префиксами](#css)
  - [Правила с одиночными объявлениями](#css)
  - [Сокращенная запись](#css)
  - [Stylus](#css)
  - [Комментарии](#css)
  - [БЭМ и именование классов](#css)
  - [Селекторы](#css)
  - [Организация кода](#css)


## <a name="common">Общее положение</a>
...
- При копировании строк кода из примеров внешних источников - **форматировать код в соответсвии со стандартом**.
...
### <a name="html-form">Элементы и атрибуты элементов форм</a>

- Форма должна иметь атрибуты:
  - `action` - для указания адреса отправки данных.
  - `method` - метод передачиданных, обычно в значении указывается `post`.
```
<!-- Плохо -->
<form>
  <!-- ... -->
...
- Если списки с выбором одного или нескольких значений генерируются с помощью JavaScript, то выбранное значение должно отмечаться в дочернем элементе `<option value="1" selected>Jade</option>` или , если тег `select` не используется, то сохраняться в теге `<input type="text">`.
...
### <a name="html-links-protocol">Ссылки с протоколами</a>
...
### <a name="html-javascript">Разметка, генерируемая с помощью JavaScript</a>
