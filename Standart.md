...
- Табуляцию для отступов вместо пробелов. В любом редакторе кода размер можно настроить на своё усмотрение (например, размер табуляции 4).<br>
...
- 1 перенос на новою строку после `}` и между группами объявлений.
...
### <a name='#css-stylus-syntax'>Stylus</a>
...
### <a name='#css-bem'>БЭМ и именование классов</a>
